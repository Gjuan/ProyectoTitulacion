...
<script language="JavaScript" type="t<?php echo RUTABASE; ?>/ext/javascript" src="views/src/js/ajax.js"></script>
    <script type="text/javascript">
        ...
        //console.log(words[3]);
        document.getElementById('id_cat').value=(words[0]) ;
        document.getElementById('cat').value=(words[1]) ;
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                 <?php
                      ...
                      $Lista -> lis_categoria_controller();
                  ?>
                </tbody>
              </table>
            </div>
                  ...
                  <div class="box-body">
                    ...
                    <div class="col-xs-12">
                      <div class="form-group">
                        ...
                        <input class="form-control"  name="cat" id="cat" value="" placeholder="Categoria" type="text" required=""  >
                         <input class="form-control"  name="id_cat" id="id_cat" value="" placeholder="Categoria" type="hidden" required=""  >
                      </div>
                    </div>
                    <div class="col-xs-12">
              <div class="form-group">
