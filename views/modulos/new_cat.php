    ...
    <div class="col-xs-8">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Formulario de Ingreso de Catregoria</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
          ...
          <div class="box-body">
            ...
            <div class="col-xs-12">
              <div class="form-group">
                ...
                <input class="form-control" id="Categoria" name="cat" placeholder="Categoria" type="text" required" >
              </div>
            </div>
